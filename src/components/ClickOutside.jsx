  ...
  return (
    ...
    <div ref={menuRef}  className="w-[150px] relative">
       ...
       onClick={()=>{setShow(!show)}}
        ...
        <div className={`absolute w-[115px] text-center rounded top-[50px] left-[0px] ${show == true ? "" : "hidden"}`}>
            <ul className='bg-orange-300 '> 
                <li>
                    <a  onClick={()=>{setShow(false)}} href="https://www.youtube.com/" target='_blank'>Hello</a>
                </li>
                <li>Hello</li>
                <li>Hello</li>
                <li>Hello</li>
