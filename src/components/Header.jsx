...
let Header = () => {
  ...
  let subTotal = cartInfo.reduce(
    (total, item) => total + item.price * item.qun,
    0
  );
  useEffect(() => {
  ...
  return (
    <section
      id="header"
      className="bg-[#F5F5F3] py-[25px] lg:px-7 md:px-7 sm:px-0 px-7"
    >
      <Container>
          ...
          <div className="w-1/4 relative">
            <div ref={catagoriRef} className="flex items-center">
              <HiOutlineBars3BottomLeft
                ...
                onClick={() => setCatagorishow((prev) => !prev)}
              />
              <h4 className="text-[#262626] font-dm-sans font-normal text-base leading-[18px] hidden lg:block">
                Shop by Category
              </h4>
              {catagorishow && (
                  ...
                  <ul onClick={() => setCatagorishow(false)}>
                    {category.map((item, i) => (
                      <li
                        ...
                        key={i}
                        className="font-dm-sans text-[#b1adad] font-normal text-base hover:pl-[31px] pl-[21px] py-[16px] duration-500 cursor-pointer hover:text-white ease-in-out border-b-2 border-[#6b6969]"
                      >
                        <Link to="/shoppage">{item}</Link>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <div className="w-2/4">
            <div className="relative">
              <input
                ...
                className="w-full h-[50px] placeholder:text-[#C4C4C4] text-black lg:pl-3 pl-1"
                type="text"
                ...
                <div className="absolute z-50 top-[52px] overflow-y-scroll left-0 lg:h-[400px] h-[250px] w-full p-[20px] bg-[#F5F5F3] scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-[#F5F5F3] cursor-pointer">
                  {searchFilter.map((item, i) => (
                    <div
                      ...
                      className={`lg:flex items-center gap-x-[100px] lg:pl-[150px] ${
                  ...
                  <div className="absolute z-50 top-9 right-0 text-center w-[200px]">
                    <Link to="/Myaccountpage">
                      <button
                        ...
                        className="w-[196px] py-[16px] bg-white hover:bg-black duration-500 hover:text-white text-black font-dm-sans font-bold text-base mb-1"
                      >
                        My Account
                      </button>
                    </Link>
                    <Link to="/loginpage">
                      <button
                        onClick={() => setUsershow(false)}
                        className="w-[196px] py-[16px] bg-white hover:bg-black duration-500 hover:text-white text-black font-dm-sans font-bold text-base"
                      >
                        Log Out
                      </button>
                    </Link>
                    ...
                    {cartshow && (
                      <div className="absolute border-[1px] border-[#dfdfdb] z-50 top-7 w-[350px] right-[-25px] lg:right-0 lg:w-[360px] bg-white">
                        {cartInfo.map((item, i) => (
                          <div
                            key={i}
                            className="flex items-center mb-2 justify-between py-[20px] pr-[15px] bg-[#F5F5F3]"
                          >
                            <div className="w-[80px]">
                              <img src={item.thumbnail} alt="thumbnail" />
                            </div>
                            <div className="w-[60%]">
                              <h4 className="font-bold font-dm-sans text-base leading-[18px] py-2">
                                {item.title}
                              </h4>
                              <p className="font-bold font-dm-sans text-base leading-[18px]">
                                {item.price}
                              </p>
                            </div>
                        ...
                        <div className="p-[20px]">
                          <div className="pb-[13px]">
                            <h4 className="font-dm-sans pb-[13px] text-[18px] leading-[18px]">
                              Subtotal:{" "}
                          ...
                          <div className="flex justify-around">
                            <button
                              ...
                              className="lg:py-[16px] py-2 px-5 lg:px-[41px] border-black border-2 hover:bg-black hover:text-white duration-500"
                            >
                              View Cart
                            </button>
